...
class CRepositoryConfig():
    ...
    def __init__(self, sCalledBy=None):
        ...
        self.__dictRepositoryConfig['PACKAGEVERSION'] = project.get("version", "")
        application = tool.get("RobotFrameworkAIO", "")
        self.__dictRepositoryConfig['PACKAGEDATE'] = application.get("released", "")
    ...
    def __InitConfig(self):
        ...
        self.__dictRepositoryConfig['DOCUMENTATIONBUILDER'] = CString.NormalizePath(f"{self.__sReferencePath}/genmaindoc.py")
