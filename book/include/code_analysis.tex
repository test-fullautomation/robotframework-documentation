...
Further examples can be found in the RobotFramework AIO tutorial, chapter \rlog{901_static_code_analysis}.
...
\begin{robotlisting}
"%RobotPythonPath%/python.exe" -m robocop "<path to test files folder>/mytestfile.robot"
\end{robotlisting}
...
\begin{robotlisting}
"%RobotPythonPath%/python.exe" -m robocop --argumentfile "<path to robocop.arg folder>/robocop.arg" "<path to test files folder>/mytestfile.robot"
\end{robotlisting}
...
\begin{robotlisting}
"%RobotPythonPath%/python.exe" -m robocop --argumentfile "<path to robocop.arg folder>/robocop.arg" "<path to test files folder>"
\end{robotlisting}
