...
\begin{boxhint}{Notice}
   If you are working behind a company proxy, you need to configure the proxy settings in VSCodium to access
   the extension marketplace. Details about how to do this can be found
